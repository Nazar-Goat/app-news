# Generated by Django 5.2.10 on 2026-01-27 11:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proceeded_at', models.DateTimeField(blank=True, null=True)),
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='subscribe.subscription')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('canceled', 'Canceled'), ('failed', 'Failed'), ('succeeded', 'Succeeded'), ('pending', 'Pending')], default='pending', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
